...
define i32 @setIndex(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
...
define i32 @main() #0 {
  ...
  %3 = getelementptr inbounds [1 x i32], ptr %2, i64 0, i64 0
  %4 = call i32 @setIndex(ptr noundef %3, i32 noundef 0, i32 noundef 1)
